...
const Nav = () => {
    ...
    return (
        <MDBNavbar expand="lg" dark bgColor="dark">
            <MDBContainer fluid>
                <MDBNavbarBrand >
                    <MDBNavbarLink href="/" className="link-info mx-2 shadow-5-strong">
                        JIMS GYM
                    </MDBNavbarLink>
                </MDBNavbarBrand>
                <MDBNavbarToggler onClick={() => setShowNav(!showNav)} >
                    <MDBIcon fas icon="dumbbell" className="link-info mx-2 shadow-5-strong" />
                </MDBNavbarToggler>
                        ...
                        {navLinks.map((link, index) =>
                            <>
                                <MDBNavbarItem key={link + index}>
                                    <MDBNavbarLink href={link} className="text-info mx-2 shadow-3-strong">
                                        {link.replace("#", " ")}
                                    </MDBNavbarLink>
                                </MDBNavbarItem>
                            </>
